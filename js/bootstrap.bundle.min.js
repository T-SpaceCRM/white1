...
!(function (t, e) {
        ...
        (Z = (function () {
          ...
          return (
            ...
            (t._getItemIndex = function (t) {
              return (
                (this._items = k.makeArray(k(t).parent().find(J.ITEM))), this._items.indexOf(t)
              );
            }),
      ...
      Et =
        ...
        (pt = (function () {
          ...
          return (
            ...
            (t._getConfig = function (t) {
              return (
                ((t = c({}, rt, t)).toggle = Boolean(t.toggle)), gt.typeCheckConfig(tt, t, ot), t
              );
            }),
  ...
  function Pt(t, e) {
    ...
    if ((t !== l && e !== l) || i.contains(r))
      return 'BODY' === (a = (s = l).nodeName) || ('HTML' !== a && kt(s.firstElementChild) !== s)
        ? kt(l)
        : l;
    var c = Lt(t);
      ...
      (on = (function () {
        ...
        return (
          ...
          (t._resetScrollbar = function () {
            ...
            'undefined' != typeof t &&
              Ve(document.body).css('padding-right', t).removeData('padding-right');
          }),
          ...
          (t.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              sn(i).data(this.constructor.DATA_KEY, this),
                sn.contains(this.element.ownerDocument.documentElement, this.tip) ||
                  sn(i).appendTo(a),
