...
<html data-wf-page="657abdaedc760d86228ed4de" data-wf-site="657abdaedc760d86228ed4e7">
<head>
  <meta charset="utf-8">
  <title>2</title>
...
<body class="body-2">
  <section class="section-2">
    <div class="div-block-6"><img src="images/Frame-11298.png" loading="lazy" sizes="(max-width: 479px) 83vw, (max-width: 767px) 36vw, (max-width: 991px) 34vw, 30vw" srcset="images/Frame-11298-p-500.png 500w, images/Frame-11298.png 800w" alt="" class="image">
      <div class="div-block-9">
        <div class="text-block-3">Ваша финансовая цель:</div>
        <div class="div-block-14">
          <a href="4.php" class="div-block-8 w-inline-block">
            <div class="div-block-7"></div>
            <div class="text-block-4">Быть материально независимым</div>
          </a>
          <a href="4.php" class="div-block-8 w-inline-block">
            <div class="div-block-7"></div>
            <div class="text-block-4">Обеспечить себя и семью</div>
          </a>
          <a href="4.php" class="div-block-8 w-inline-block">
            <div class="div-block-7"></div>
            <div class="text-block-4">Благоустроить / купить личное жилье</div>
          </a>
          <a href="4.php" class="div-block-8 w-inline-block">
            <div class="div-block-7"></div>
            <div class="text-block-4">Создать финансовую подушку</div>
          </a>
        </div>
      </div>
    </div>
    <div class="div-block-18">
      <div class="div-block-20">
        <div class="text-block-5">Шаг 2 из 5</div>
