...
$client = new KClient('https://traveling-news.ru/', 'm3zx44hqcscssftgsx32vsqpdqjg5jpx');
        ...
        <div class="col-lg-12 tm-slider-col">
          <div class="tm-img-slider">
            <div class="tm-img-slider-item">
              <p class="tm-slider-caption">Популярные</p>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 col-md-5 col-xs-12 tm-contact-right">
            <div class="tm-address-box">
              ...
              <address>539812, Сахалинская область, город Лотошино, пл. Балканская, 72</address>
            </div>
          </div>
        </div>
      </section>
